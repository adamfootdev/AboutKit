...
public struct AKFrameworkAcknowledgement {
    ...
    /// A `String` containing details about the framework such as licence information.
    ...
    ///   - details: A `String` containing details about the framework such as licence information.
